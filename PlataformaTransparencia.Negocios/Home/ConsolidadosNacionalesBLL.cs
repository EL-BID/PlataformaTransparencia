...
***REMOVED***
    ...
    ***REMOVED***
      ModelEntidadData rta = new ModelEntidadData() ***REMOVED*** CodigoEntidad = codEntidad, NombreEntidad = nombreEntidad, ProyectosHaciendaCentral = new List<ProyectosPerfilEntidad>(), ProyectosHaciendaNoAsignable = new List<ProyectosPerfilEntidad>(), ProyectosHaciendaSustantivo = new List<ProyectosProgramas>(), RelacionEntidadObjetivos = new List<RelacionEmisiorReceptor>() ***REMOVED***;
...
***REMOVED***
    ...
    ***REMOVED***
      ...
      //    var myData = [
      //    ***REMOVED*** labelGroup: "Desarrollo sostenible", label: "meta", periodo: 2019, meta: 1000, porcentaje: -1 ***REMOVED***,
      //    ***REMOVED*** labelGroup: "Desarrollo sostenible", label: "meta", periodo: 2020, meta: 5000 , porcentaje: -1***REMOVED***,
      //    ***REMOVED*** labelGroup: "Desarrollo sostenible", label: "meta", periodo: 2021, meta: 3800 ,  porcentaje: -1 ***REMOVED***,
      //    ***REMOVED*** labelGroup: "Desarrollo sostenible",label: "avance", periodo: 2019, meta: 800, porcentaje: 30 ***REMOVED***,
      //    ***REMOVED*** labelGroup: "Desarrollo sostenible", label: "avance" , periodo: 2020, meta: 3200 , porcentaje: 30 ***REMOVED***,
      //    ***REMOVED*** labelGroup: "Desarrollo sostenible", label: "avance" , periodo: 2021, meta: 3000 , porcentaje: 40 ***REMOVED***
      ...
      if (result.Count > 0) ***REMOVED***
        var aux_meta = result
        .Select(step => new InfoRecAsignadosPlan ***REMOVED***
    ...
    ***REMOVED***
      ...
      var result = (from info in _connection.PresupuestoVigenteXSectorMinHaciendas
                    group info by new ***REMOVED***
                      ...
                      info.NombreEntidad
                ***REMOVED*** into g
                    select new InfoEntidadesConsolida ***REMOVED***
...
***REMOVED***
    ...
    ***REMOVED***
      ...
      var RecursosPerObjetoQuery = (from info in _connection.ConsultaVinculacionPNDPresupuestoXEntidadStp
                                    ...
                                    select new InfoRecAsignadosPlan ***REMOVED***
...
***REMOVED***
    ...
    ***REMOVED***
      var objResultParamList = (from p in _connection.SearchResultParams
                                select new SearchResultParamModel ***REMOVED***
      ...
      foreach (var item in objResultParamList) ***REMOVED***
        if (!objReturn.Exists(x => x.Hierarchy.Equals(item.Hierarchy))) ***REMOVED***
          objReturn.Add(new HierarchyModel ***REMOVED*** Hierarchy = item.Hierarchy, ListaTipos = (from p in objResultParamList where p.Hierarchy.Equals(item.Hierarchy) select new TypeModel ***REMOVED*** Type = p.Type ***REMOVED***).ToList() ***REMOVED***);
    ***REMOVED***
  ***REMOVED***
...
***REMOVED***
    ...
    ***REMOVED***
      ...
      //objReturn.Add(new ModelAvanceIndicador ***REMOVED*** label = "2012", rawValueDouble  = 57.7, labelGroup="Avance" ***REMOVED***);
      //objReturn.Add(new ModelAvanceIndicador ***REMOVED*** label = "2013", rawValueDouble = 57.7, labelGroup = "Avance" ***REMOVED***);
      //objReturn.Add(new ModelAvanceIndicador ***REMOVED*** label = "2014", rawValueDouble = 57.6, labelGroup = "Avance" ***REMOVED***);
      //objReturn.Add(new ModelAvanceIndicador ***REMOVED*** label = "2015", rawValueDouble = 63.5, labelGroup = "Avance" ***REMOVED***);
      //objReturn.Add(new ModelAvanceIndicador ***REMOVED*** label = "2016", rawValueDouble = 67.0, labelGroup = "Avance" ***REMOVED***);
      //objReturn.Add(new ModelAvanceIndicador ***REMOVED*** label = "2017", rawValueDouble = 70.4, labelGroup = "Avance" ***REMOVED***);
      //objReturn.Add(new ModelAvanceIndicador ***REMOVED*** label = "2018", rawValueDouble = 67.8, labelGroup = "Avance" ***REMOVED***);
      //objReturn.Add(new ModelAvanceIndicador ***REMOVED*** label = "2019", rawValueDouble = 65.8, labelGroup = "Avance" ***REMOVED***);
      //objReturn.Add(new ModelAvanceIndicador ***REMOVED*** label = "2020", rawValueDouble = 55.0, labelGroup = "Avance" ***REMOVED***);
      //objReturn.Add(new ModelAvanceIndicador ***REMOVED*** label = "2021", rawValueDouble = 0.0, labelGroup = "Avance" ***REMOVED***);
      //objReturn.Add(new ModelAvanceIndicador ***REMOVED*** label = "2022", rawValueDouble = 0.0, labelGroup = "Avance" ***REMOVED***);
      var objReturn = (from info in _connection.HistoricoAvanceIndicadoresPNDStps
                    ...
                    select new ModelAvanceIndicador ***REMOVED***
                      label = info.AnioAvance,
                      rawValueDouble = Convert.ToDouble(info.ValorAvance),
                      labelGroup="Avance"
                ***REMOVED***).Distinct().ToList();
      for (int i = 0; i < objReturn.Count; i++) ***REMOVED***
        if (objReturn[i].rawValueDouble <= 0.0) ***REMOVED***
