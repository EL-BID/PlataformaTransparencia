...
***REMOVED***
    ...
    ***REMOVED***
      ...
      foreach (var fila in infoQuery) ***REMOVED***
        objEje = objReturn.Find(p => p.Id == fila.IdCodEje.ToString());
        if (objEje == null) ***REMOVED***
          ...
          if (objEstrategico == null) ***REMOVED***
  ...
  ***REMOVED***
      ...
      foreach (var item in result) ***REMOVED***
        ...
        foreach (var item_estrateg in item.Detalles) ***REMOVED***
...
***REMOVED***
    ...
    ***REMOVED***
      ...
      //                                            group proyectoHaciendaCentral by new ***REMOVED***
      ...
      foreach (var proyectoHaciendaCentral in proyectosHaciendaAgrupPorPresupuesto) ***REMOVED***
        ...
        ProyectosPerfilEntidad nuevoProyecto = new ProyectosPerfilEntidad() ***REMOVED*** Indicadores = new List<IndicadorProyecto>() ***REMOVED***;
        ...
        foreach (var indicadorProyectoActividad in indicadoresProyectoActividad) ***REMOVED***
          ...
          nuevoProyecto.Indicadores.Add(new IndicadorProyecto ***REMOVED***
            Avance = avance,
...
***REMOVED***
    ...
    ***REMOVED***
      ...
      try ***REMOVED***
        ...
        foreach (var programa in programaProyectosHaciendaSustantivos) ***REMOVED***
          ...
          //ProyectosProgramas nuevoProgramaProyecto = new ProyectosProgramas ***REMOVED*** NombrePrograma = programa.NombrePrograma == null ? string.Empty : ConvertirTextoMayusculaMinuscula(programa.NombrePrograma), PresupuestoAsignado = presupuestoAsignado.HasValue ? Math.Round(presupuestoAsignado.Value / 1000000, 0) : 0, Problematica = problematicaPrograma == null ? string.Empty : ConvertirTextoMayusculaMinuscula(problematicaPrograma), ResultadoInmediato = resultadoInmediato == null ? string.Empty : ConvertirTextoMayusculaMinuscula(resultadoInmediato), ResultadoIntermedio = resultadoIntemedio == null ? string.Empty : ConvertirTextoMayusculaMinuscula(resultadoIntemedio), Proyectos = new List<ProyectosPerfilEntidad>() ***REMOVED***;
          ProyectosProgramas nuevoProgramaProyecto = new ProyectosProgramas ***REMOVED*** NombrePrograma = programa.NombrePrograma == null ? string.Empty : ConvertirTextoMayusculaMinuscula(programa.NombrePrograma), PresupuestoAsignado =  Math.Round(programa.PresupuestoAsignado / 1000000, 0), Problematica = programa.Problematica == null ? string.Empty : ConvertirTextoMayusculaMinuscula(programa.Problematica), ResultadoInmediato = string.Empty, ResultadoIntermedio = programa.ResultadoIntermedio == null ? string.Empty : ConvertirTextoMayusculaMinuscula(programa.ResultadoIntermedio), Proyectos = new List<ProyectosPerfilEntidad>() ***REMOVED***;
          ...
          //                                                      group proyectoHaciendaNoAsignable by new ***REMOVED***
          ...
          foreach (var proyectoHaciendaSustantivo in proyectosHaciendaSustantivoAgrupPorPresupuesto) ***REMOVED***
            var indicadoresProyectoActividad = (from info in _connection.PresupuestoIndicadoresMinHaciendas
...
***REMOVED***
    ...
    ***REMOVED***
      ...
      var data = (from info in _connection.PresupuestoIndicadoresMinHaciendas
                  ...
                  select new TableIndicadorGraphics ***REMOVED***
